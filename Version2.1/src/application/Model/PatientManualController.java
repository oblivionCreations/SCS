...
//						batteryvalue = batteryvalue - 0.01;
				...
				//		System.out.println(" ............ Here in normal state");
					...
					refferenceBatery = refferenceBatery - (1-referanceInsulinprogressbar)/5-(1-referanceGlucagonprogressbar)/5 -counter/300;
				//	pb_battery.setProgress(1-(1-referanceInsulinprogressbar)/5-(1-referanceGlucagonprogressbar)/5 - counter/300);
				//	projectedTime.setText((f.format(referanceGlucagonprogressbar)));
					pb_battery.setProgress(refferenceBatery);
